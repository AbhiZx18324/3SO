...
const CLIENT_ID = "app1"; // Change per client
const CLIENT_SECRET = "app1_secret"; // Change per client
const CLIENT_PORT = 3001; // Change per client
...
app.get("/logout", async (req, res) => {
  ...
  // res.redirect(`${SSO_SERVER}/logout`);
  // req.session.destroy(() => {
